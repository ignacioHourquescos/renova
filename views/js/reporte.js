...
pedido
  .then(() => {
    ...
    ventasPorAgrupacion(selected, anio[0].mes, anio[0].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[1].mes, anio[1].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[2].mes, anio[2].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[3].mes, anio[3].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[4].mes, anio[4].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[5].mes, anio[5].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[6].mes, anio[6].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[7].mes, anio[7].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[8].mes, anio[8].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[9].mes, anio[9].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[10].mes, anio[10].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[11].mes, anio[11].codigo);
  })
  .then(() => {
    ventasPorAgrupacion(selected, anio[12].mes, anio[12].codigo);
  })
  .then(() => {
    console.log(ventasFiltros);
  })
  .then(() => {
    setTimeout(() => {
      ...
      renderizarGrafico();
      console.log("llegamso hasta aca");
    }, 4000);
  });
